<?php
  define('HTTP_SERVER', 'http://bellog.org');
  define('HTTP_CATALOG_SERVER', 'http://bellog.org');
  define('HTTPS_CATALOG_SERVER', 'http://bellog.org');
  ...
  define('DB_SERVER_PASSWORD', 'asdLweMC0');
