 ...
 */
$gallery->setConfig('data.gallery.base', '/var/www/html/gallery/g2data/');
...
$storeConfig['password'] = 'asdLweMC0';
$storeConfig['schema'] = '';
 ...
 */
$gallery->setConfig('baseUri', 'http://bellog.org/gallery/main.php');
?>
